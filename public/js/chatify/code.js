  ...
  if (messenger != 0) {
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        $(".messenger-infoView")
          .find(".avatar")
          .css("background-image", 'url("http://127.0.0.1:8000/assets/img/users/' + data.fetch.profile_Image + '")');
        $(".header-avatar").css(
          "background-image",
          'url("http://127.0.0.1:8000/assets/img/users/' + data.fetch.profile_Image + '")'
        );
